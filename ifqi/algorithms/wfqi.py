...
class WFQI(Algorithm):
    """
    This class implements the Weighted Fitted Q-Iteration algorithm.
    ...
    def __init__(self, estimator, state_dim, action_dim,
        ...
        self.__name__ = 'WFQI'
        super(WFQI, self).__init__(estimator, state_dim, action_dim,
                                  discrete_actions, gamma, horizon,
                                  verbose)

    def partial_fit(self, sast=None, r=None, wp=None, wr=None, **kwargs):
        """
        ...
        if self._iteration == 0:
            ...
            y = self._wr*self._r + self._wp*self.gamma * maxq
    ...
    def fit(self, sast, r, wp,wr, **kwargs):
        """
